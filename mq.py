# Title: Raspberry-Pi-Gas-Sensor-MQ
# Author: tutRPi (https://github.com/tutRPi)
# Date accessed: 10/02/2018
# Availability: https://github.com/tutRPi/Raspberry-Pi-Gas-Sensor-MQ
...
class MQ():
    ...
    def __init__(self, adc, Ro=10, analog_channel=0):
        self.Ro = Ro
        self.MQ_PIN = analog_channel
